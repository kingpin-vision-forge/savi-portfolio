...
export default function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  if (!isVisible && progress >= 100) {
    return (
      <div className="fixed inset-0 z-50 bg-[#050505] opacity-0 animate-fade-out pointer-events-none" />
    );
  }

  return (
    <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-[#050505] refraction-bg transition-opacity duration-500 ${progress >= 100 ? 'opacity-0' : 'opacity-100'}`}>
