      ...
      <main className="relative pt-20 flex flex-col items-center">
        ...
        <section className="relative w-full min-h-[90vh] flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-[1280px] px-4 md:px-10 flex flex-col items-center text-center">
            <div className="glass-panel p-6 sm:p-10 md:p-16 rounded-3xl max-w-4xl backdrop-blur-xl border border-white/10 shadow-2xl">
              ...
              <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-light tracking-tighter text-white mb-6 sm:mb-8 drop-shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button className="flex items-center justify-center h-14 px-10 rounded-3xl bg-white text-[#1a1a1a] text-sm font-bold tracking-widest uppercase hover:bg-[#00C853] hover:text-white transition-all hover:-translate-y-0.5 shadow-[0_0_20px_rgba(255,255,255,0.15)]">
                  Our Journey
                </button>
                <button className="flex items-center justify-center h-14 px-10 rounded-3xl bg-transparent border border-white/20 text-white text-sm font-bold tracking-widest uppercase hover:bg-[#00C853]/10 hover:border-[#00C853]/50 transition-all group">
        ...
        <div className="w-full max-w-[1280px] px-4 md:px-10 -mt-24 relative z-20 mb-32">
          <div className="bg-[#222222] border border-white/10 rounded-3xl p-4 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] grid grid-cols-3 gap-2 sm:gap-8 divide-x divide-white/5">
            <div className="flex flex-col items-center text-center p-2 sm:p-4 group">
              <span className="text-2xl sm:text-4xl font-light text-white mb-2 group-hover:text-[#00C853] transition-colors duration-500">99.9%</span>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Purity Level</span>
            </div>
            <div className="flex flex-col items-center text-center p-2 sm:p-4 group">
              <span className="text-2xl sm:text-4xl font-light text-white mb-2 group-hover:text-[#00C853] transition-colors duration-500">50+</span>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Natural Springs</span>
            </div>
            <div className="flex flex-col items-center text-center p-2 sm:p-4 group">
              <span className="text-2xl sm:text-4xl font-light text-white mb-2 group-hover:text-[#00C853] transition-colors duration-500">0</span>
            ...
            {[
              ...
              <div key={i} className="flex gap-6 items-start group">
                ...
                <div className="flex flex-col flex-1">
                  <div className="bg-[#2a2a2a] p-4 sm:p-8 rounded-2xl sm:rounded-3xl hover:shadow-2xl transition-all duration-500 border border-white/5 hover:border-white/20">
