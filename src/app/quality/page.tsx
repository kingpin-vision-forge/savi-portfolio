      ...
      <main className="flex min-h-screen flex-col pt-32 pb-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-20 w-full">
          ...
          <div className="flex flex-col items-center text-center mb-24">
            ...
            <h1 className="text-white text-5xl md:text-7xl font-extrabold tracking-tight mb-8 text-glow leading-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-end gap-1">
                      <span className="text-6xl font-extrabold text-white tracking-tighter">7.4</span>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-end gap-1">
                      <span className="text-6xl font-extrabold text-white tracking-tighter">280</span>
